...
async def test_save_uploaded_file(mock_upload_file, mocker):
    ...
    stored_filename, original_filename = await storage.save_uploaded_file(mock_upload_file)
...
async def test_save_avatar_file(mock_upload_file, mocker):
    ...
    stored_filename, original_filename = await storage.save_avatar_file(mock_upload_file)
