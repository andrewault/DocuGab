...
class TestCustomerList:
    ...
    async def test_list_customers_as_admin(
    ...
    async def test_list_customers_as_user_forbidden(
...
class TestCustomerCreate:
    ...
    async def test_create_customer_as_user_forbidden(
        self, client: AsyncClient, auth_headers
    ):
...
class TestCustomerUpdate:
    ...
    async def test_update_nonexistent_customer(
        self, client: AsyncClient, admin_auth_headers
    ):
...
class TestCustomerDelete:
    ...
    async def test_delete_customer_as_user_forbidden(
        self, client: AsyncClient, auth_headers
    ):
