...
class TestAdminUserUpdate:
    ...
    async def test_update_user_role(self, client: AsyncClient, admin_auth_headers, test_user):
    ...
    async def test_update_nonexistent_user(self, client: AsyncClient, admin_auth_headers):
...
class TestAdminUserDelete:
    ...
    async def test_delete_user(self, client: AsyncClient, admin_auth_headers, test_user):
    ...
    async def test_regular_user_cannot_delete(self, client: AsyncClient, auth_headers, admin_user):
